    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.booking-transactions.update', $bookingTransaction) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div>
                        ...
                        <x-text-input
                            class="block mt-1 w-full bg-gray-200 cursor-not-allowed"
                            type="text"
                            :value="old('booking_trx_id', $bookingTransaction->booking_trx_id)"
                            disabled
                        />
                        <x-text-input id="booking_trx_id" type="hidden" name="booking_trx_id"
                            :value="old('booking_trx_id', $bookingTransaction->booking_trx_id)"
                        />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                            :value="old('name', $bookingTransaction->name)" autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="phone_number" class="block mt-1 w-full" type="tel" name="phone_number"
                            :value="old('phone_number', $bookingTransaction->phone_number)" required autofocus autocomplete="phone_number" />
                    ...
                    <div class="mt-4">
                        ...
                        <select name="office_space_id" id="office_space_id"
                            ...
                            @foreach ($officeSpaces as $officeSpace)
                                <option value="{{ $officeSpace->id }}"
                                   @selected(old('office_space_id', $officeSpace->id == $officeSpace->id))>
                                   {{ $officeSpace->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="total_amount" class="block mt-1 w-full" type="number" name="total_amount"
                            :value="old('total_amount', $bookingTransaction->total_amount)" required autofocus autocomplete="total_amount" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="duration" class="block mt-1 w-full" type="text" name="duration"
                            :value="old('duration', $bookingTransaction->duration)" required autofocus autocomplete="duration" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="started_at" class="block mt-1 w-full" type="date" name="started_at"
                            :value="old('started_at', $bookingTransaction->started_at->format('Y-m-d'))" required autofocus autocomplete="started_at" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="ended_at" class="block mt-1 w-full" type="date" name="ended_at"
                            :value="old('ended_at', $bookingTransaction->ended_at->format('Y-m-d'))" required autofocus autocomplete="ended_at" />
                    ...
                    <div class="mt-4">
                        ...
                        <select name="is_paid" id="is_paid"
                            ...
                            <option value="0" {{ old('is_paid', $bookingTransaction->is_paid) == 0 ? 'selected' : '' }}>Not Paid</option>
                        </select>
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <button type="submit" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                            update New Booking Transaction
                        </button>
                    </div>
                </form>
